      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-8 md:mb-0">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold">Mekonet</span>
            </div>
            <p className="mt-2 text-gray-400 max-w-xs">
              Nigeria's most trusted network of automotive technicians.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-12">
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-400">Join</h3>
              <ul className="mt-4 space-y-2">
                <li>
                  <a 
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            © {currentYear} Mekonet. All rights reserved.
          </p>
